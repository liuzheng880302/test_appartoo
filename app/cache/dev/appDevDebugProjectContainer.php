...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'zheng_user.form.registration' => 'getZhengUser_Form_RegistrationService',
        );
        $this->aliases = array(
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'appartoo', 'user' => 'root', 'password' => 'charles', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppBundle/Entity'), 1 => ($this->targetDirs[3].'/src/ZHENG/UserBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AppBundle\\Entity');
        $c->addDriver($b, 'ZHENG\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'ZHENGUserBundle' => 'ZHENG\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e8a07fc5d362dc88f8b786ece517084e75baa1fb8c6be3705c393cd6cfbb3a3e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('ZHENG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ZHENG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'zheng_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ZHENG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('ZHENG\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'ZHENG\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/contacts');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ZHENG/UserBundle/Resources/views'), 'ZHENGUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('51d5a1777aa617bb3b5f0e75d30edc7ae10dd216');
    }
    ...
    /**
     * Gets the 'zheng_user.form.registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ZHENG\UserBundle\Form\RegistrationType A ZHENG\UserBundle\Form\RegistrationType instance.
     */
    protected function getZhengUser_Form_RegistrationService()
    {
        return $this->services['zheng_user.form.registration'] = new \ZHENG\UserBundle\Form\RegistrationType();
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ZHENGUserBundle' => 'ZHENG\\UserBundle\\ZHENGUserBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'charles',
            'mailer_transport' => 'gmail',
            'mailer_host' => NULL,
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '51d5a1777aa617bb3b5f0e75d30edc7ae10dd216',
            'locale' => 'en',
            ...
            'kernel.secret' => '51d5a1777aa617bb3b5f0e75d30edc7ae10dd216',
            ...
            'fos_user.model.user.class' => 'ZHENG\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'zheng_user_registration',
